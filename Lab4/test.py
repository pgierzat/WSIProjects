...
X = data.drop(columns=["Weight"])  # Wszystkie cechy oprócz "Weight"
y = data["Weight"]

# Przekształcenie kolumny "Species" na kategorie numeryczne
...
# Testowanie modeli dla różnych wartości lambda i learning_rate
best_l1_model = None
best_l2_model = None
...
print("Best L1 Model score: ", best_l1_score)
print("best l2 model score: ", best_l2_score)
...
# Przewidzenie wartości na podstawie najlepszych modeli
l1_predictions = best_l1_model.predict(X_test)
l2_predictions = best_l2_model.predict(X_test)

# Wykres liniowej regresji dla najlepszych modeli
...
# Wykres różnicy między rzeczywistą a przewidywaną wagą
